package com.openly.shared.ui.requests
...
@Composable
fun RequestsScreen(container: AppContainer, selfUid: String) {
    val viewModel: RequestsViewModel = viewModel(
        factory = viewModelFactory {
            initializer {
                RequestsViewModel(selfUid, container.interestRepository, container.profileRepository)
            }
        }
    )
