package com.openly.shared.ui.settings
...
import com.openly.shared.data.local.DEFAULT_RADAR_RADIUS_METERS
import kotlinx.coroutines.launch
import kotlin.math.roundToInt

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun SettingsScreen(container: AppContainer, selfUid: String) {
    val profile by container.profileRepository.observeOwnProfile(selfUid).collectAsState(initial = null)
    val radiusMeters by container.prefs.radarRadiusMeters.collectAsState(initial = DEFAULT_RADAR_RADIUS_METERS)
                ...
                Row(
                    ...
                    Switch(
                        ...
                        onCheckedChange = { checked ->
                            scope.launch { container.profileRepository.setOpenStatus(selfUid, checked) }
                        }
                    )
                }
            }
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    Slider(
                        ...
                        onValueChangeFinished = {
                            scope.launch { container.prefs.setRadarRadiusMeters(sliderPosition.toDouble()) }
                        },
                        valueRange = 50f..500f
                    )
                }
